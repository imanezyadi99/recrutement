...
<div class="container card py-5 px-4 my-5 ">
    <div class="row ">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <a href="{{ url('/dashboard/Espace_Recruteur')}}" class="btn btn-info">retour</a>
        </div>
      </div>
    <div class="col-sm-6">
    ...
    <div class="row p-3">
        ...
        <div class="col-sm-6">
           <p><b> Poste: </b> {{ $client->poste}}</p>
           <p><b> Description: </b> {{ $client->description}}</p>
           <p><b> Nom société: </b> {{ $client->nom_societe}}</p>
           <p><b> Ville société: </b> {{ $client->ville_societe}}</p>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              Voulez-vous supprimer cette fiche de <b> {{ $client->poste}}  </b> definitivment ?
            </div>
