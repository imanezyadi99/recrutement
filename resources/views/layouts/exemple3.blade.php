...
<head>
    ...
    <link rel="stylesheet" href="{{URL::asset('recrutement/css/job.css')}}">
    <link rel="stylesheet" href="{{URL::asset('recrutement/css/style.css')}}">
          ...
          <div class="search-container">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1>
                            Ici, nous vous aidons à trouver votre <br> <br/> prochain Emploi qui  correspond  à votre vie !
                        </h1>
                    </div>
    		...
    		<div class="container">
              ...
              <div class="widget">
                ...
                <div class="textwidget">
                  ...
                  <li>
                    <a href="/inscription-candidat">S'inscrire</a>
                </li>
